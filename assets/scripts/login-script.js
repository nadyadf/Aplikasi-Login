...
loginFormElement.addEventListener('submit', function(event) {
  ...
  */
  ...
  /* Comment: Memastikan bahwa nilai email & password sesuai dengan nilai yang tersimpan. */
  if (email == expectedEmail && password == expectedPassword) {
    ...
    /* Comment: Namun jika tidak sesuai maka akan menampikankan informasi bahwa input salah */
    showPopUp();
